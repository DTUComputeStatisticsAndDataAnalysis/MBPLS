...
initiate_files = True
if initiate_files:
    pickle.dump(indicator_matrix, open('indicator_matrix_rowincrease.pkl', 'wb'))
    pickle.dump(timing_results, open('timing_results_rowincrease.pkl', 'wb'))
...
while not finished:
    while True:
        ...
        indicator_matrix = pickle.load(open('indicator_matrix_rowincrease.pkl', 'rb'))
        try:
    ...
    print('Loading data')
    timing_results_tmp = pickle.load(open('timing_results_rowincrease.pkl', 'rb'))
        ...
        for j, (methodname, method) in enumerate(methods):
            ...
            if timing_results_tmp.mean(axis=3)[j].max() > 630:
                ...
                if method == 'Ade4':
                    ...
                    if include_timing:
                        timing_results[j, feature_index, sample_index, run] = \
                            time.time() - timing_results[j, feature_index, sample_index, run]
    ...
    print('Loading data')
    indicator_matrix_shared = pickle.load(open('indicator_matrix_rowincrease.pkl', 'rb'))
    timing_results_shared = pickle.load(open('timing_results_rowincrease.pkl', 'rb'))
